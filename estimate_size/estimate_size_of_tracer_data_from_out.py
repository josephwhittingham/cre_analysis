# Might be further savings from compression (extra 10% typical?)
# Need to check that data chunk sizes are accurate (how many fields are we saving?)

with open("78376.out") as file:
